...
public class AltaConocimientoController {
    ...
    protected String onSubmit(ConocimientoViewForm conocimiento, BindingResult result){
    ...
    protected ConocimientoViewForm formBackingObject(HttpServletRequest req)throws Exception{
